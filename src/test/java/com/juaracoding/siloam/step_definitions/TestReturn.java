...
import com.juaracoding.siloam.pages.MenuNew;
...
public class TestReturn {
    ...
    public void klik_btn_reset_search() {
        ...
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.105 klik button reset textbox search");
    }
    ...
    public void klik_select_pages_() {
        menuNew.klikSelectages();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.109 klik select pages");
    }

    @Then("TCC.SILOAM select 10")
    public void select_sepuluh_() {
        menuNew.inputSepuluhShowPages("10");
        extentTest.log(LogStatus.PASS, "TCC.SILOAM select 10");
    }
    ...
    // menampilkan button aksi

    @When("TCC.SILOAM.120 menampilkan button aksi view data")
    public void menampilkan_button_aksi() {
        menuNew.buttonAksiView();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.120 menampilkan button aksi view data");
    }

    @Then("TCC.SILOAM.120 validasi button aksi view data")
    public void validasi_button_aksi() {
        menuNew.setBtnAksi();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.120 validasi button aksi view data");
    }
    ...
    public void menampilkan_scroll() {
        menuNew.scrollPage();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.121 scroll down page");
    }

    @And("TCC.SILOAM.121 klik button nex")
    public void klik_next() {
        menuNew.setBtnNextPage();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.121 klik button nex");
    }

    @Then("TCC.SILOAM.121 menampilkan halaman selanjutnya")
    public void menampilkan_halaman_selanjutnya() {
        menuNew.getTxtNextPages();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.121 menampilkan halaman selanjutnya");
    }
    ...
    public void scroll_page() {
        menuNew.scrollPage();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.122 scroll down page");
    }

    @Then("TCC.SILOAM.122 klik button previous")
    public void klik_previous() {
        menuNew.setBtnPrevious();
        extentTest.log(LogStatus.PASS, "TCC.SILOAM.122 klik button previous");
    }
